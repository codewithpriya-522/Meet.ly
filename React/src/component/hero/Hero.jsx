...
import section3Img from '../../assets/images/section-3Img.svg'
...
<AiFillWechat class="w-10 h-10 text-white dark:text-white mb-3"/>
    ...
    <section className="hero">
<div className="bg-white dark:bg-gray-900">
  <div className="grid max-w-screen-xl px-4 pt-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
  <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
      <img src={section3Img} alt="section3 image" />
    </div> 
    <div className="ml-auto place-self-center lg:col-span-7">
    <div className="my-4 flex text-sm text-[#ff8100] font-semibold leading-tight" >
    <GiLoveHowl className='h-5 w-5'/><span className='px-3'>Latest match couple</span>
    </div>
